...
if __name__ == '__main__':
    ...
    file_path = r"D:\PythonProgram\PythonProject\2026.8.22\shopkeeper_brain\docs\hybrid_auto\万用表的使用.md"
    ...
    state = {
        "file_title": "万用表的使用",
        "md_content": content,
            "file_dir":r"D:\PythonProgram\PythonProject\2026.8.22\shopkeeper_brain\knowledge\processor\import_process\import_temp_dir\万用表的使用\hybrid_auto"
